...
while (guests.length > 2) {
    ...
    let favplaces = [" Bali", "Dubai", "Greece"];
    ...
    let guestslist = [`Ahmed, Mano, Aamash , Laraib ,Rayan, Ayan, Aina`];
    console.log(`I am inviting ${guestslist.length} people to dinner`);
    //task 2 (list of languages)
    let languages = ["English", "Urdu", "Sindhi", "Punjabi"];
    ...
    let username1 = ["Admin", "Eric", "Harry"];
    let newusers = ["Admin", "Eric", "Harry", "Marry", "Albert"];
    let username1_lower = username1.map(user => user.toLowerCase());
    for (let newuser of newusers) {
        ...
        let pizzas = [`cheesy`, `chicken fajita`, `chicken tikka`];
        ...
        function describeCities(city, country = "Australia") {
            console.log(`${city} is in ${country}.`);
        }
        ...
        const magicians3 = ["Yums", "Harry", "David", "Ricky"];
        const greatmagicians2 = make_great(magicians3);
